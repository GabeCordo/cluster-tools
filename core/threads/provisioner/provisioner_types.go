...
type Thread struct {
	...
	C5 chan threads.ProvisionerRequest    // Supervisor is receiving threads from the http_thread
	C6 chan<- threads.ProvisionerResponse // Supervisor is sending responses to the http_thread

	C7 chan<- threads.DatabaseRequest  // Supervisor is sending threads to the database
