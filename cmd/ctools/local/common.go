...
var (
	...
	DefaultFrameworkFolder = filepath.Join(userCacheDir, "cluster.tools")
	CToolsFolder           = filepath.Join(DefaultFrameworkFolder, "ctools")
	CToolsConfig           = filepath.Join(CToolsFolder, "config.json")
)
