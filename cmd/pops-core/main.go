...
import (
	...
	"github.com/Sentmint/pops/cmd/pops-core/controllers"
)
...
func main() {
	...
	ic.SetCategory("utils").SetDescription("initialize the global files required to start the pops-core")
	...
	sc.SetCategory("utils").SetDescription("start the pops-core on the log system")
	...
	cc.SetCategory("utils").SetDescription("update the global pops-core configuration")
